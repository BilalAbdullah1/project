...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2023 at 08:44 PM
...
(4, 'sad', 'sad', 'sadsa', 'a4.jpg', '2', 2, 'asgasgsag');
...
(12, 'tester', 'tester@gmail.com', 'tester', 1, 'user');
...
--
ALTER TABLE `contact_tbl`
  MODIFY `abtid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
